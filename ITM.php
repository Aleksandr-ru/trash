<?php
/**
* Modified version of HTML_Template_IT 1.3.0 stable
* @copyright (c)Rebel http://aleksandr.ru
* @version 0.1
* 
* Mod 0.1 features:
* - PAER package is not required anymore, all in one file now
*/
        ...
        if (preg_match_all($this->blockRegExp, $string, $regs, PREG_SET_ORDER)) {
            foreach ($regs as $k => $match) {
                ...
                if (isset($this->blocklist[$blockname])) {
                    ...
                    */
                    $this->err[] = $this->raiseError($msg, IT_BLOCK_DUPLICATE);
